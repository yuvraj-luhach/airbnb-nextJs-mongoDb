...
const Modal:React.FC<ModalProps> = ({isOpen,onClose,onSubmit,title,body,footer,actionLabel,disabled,secondaryAction,secondaryActionLabel}) =>{
    ...
    return (
        <>
            <div className="justify-center items-center flex overflow-x-hidden fixed inset-0 z-50 outline-none focus:outline-none bg-neutral-300/50 backdrop-blur-[1px]">
                <div className="relative w-full md:w-4/6 lg:w-3/6 xl:w-2/5 my-6 mx-auto h-full lg:h-auto md:h-auto">
                    ...
                    ${showModal ? 'opacity-100' : 'opacity-0'}`}>
                        <div className="translate lg:h-auto md:h-auto border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                            ...
                            <div className="h-full lg:h-auto md:max-h-[60vh] overflow-y-scroll">
                                {/* BODY */}
                            ...
                            <div className="flex flex-col gap-2 p-6 border-t-neutral-300 border-[1px]">
