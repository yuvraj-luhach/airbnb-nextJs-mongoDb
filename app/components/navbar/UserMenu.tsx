    ...
    return (
        <div className="relative">
            <div className="flex flex-row items-center gap-3">
                ...
                <div className="md:py-1 p-4 md:px-2 border-[1px] border-neutral-200 flex flex-row items-center gap-3 rounded-full cursor-pointer hover:shadow-md transition" onClick={toggleOpen}>
                    <AiOutlineMenu/>
