...
const ListingClient:React.FC<ListingClientProps> = ({reservations = [], listing, currentUser}) => {
    ...
    const onCreateReservation = useCallback(() => {
        ...
        .then(() => {
            toast.success('Booking reservation confirmed')
        ...
        listing?.id, loginModal, router, totalPrice])
            ...
            <div className="max-w-screen-lg mx-auto">
                <div className="flex flex-col gap-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-7 md:gap-10 mt-6">
                        ...
                        roomCount={listing.roomCount} bathroomCount={listing.bathroomCount} 
                        guestCount={listing.guestCount} locationValue={listing.locationValue} />
